...
<html <?php language_attributes();?>>
  <head> <!-- this is the header page, and this page contains the menu-->
    <meta charset="utf-8">
...
<?php } else if ( is_search() ) { ?>
  <h1 class="main-title"> <?php esc_html_e('Results for:', 'project_theme'); ?> <strong><i><?php echo $s; ?></i></strong></h1>
<?php } ?>